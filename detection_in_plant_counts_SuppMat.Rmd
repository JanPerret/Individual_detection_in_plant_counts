...
**Figure S3.1:** The true number of individuals per quadrat and field session, before the four density outliers were removed. Each point represents a quadrat, and the dotted red line shows the threshold of 300 individuals, above which we removed the quadrats from the dataset to avoid the risk of leverage effect.  <br>
...
The model comparison is presented in the file “df_model_selection.csv” and is attached as a separate document.  <br>
